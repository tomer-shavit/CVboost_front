...
const SuggestionsView: React.FC<{ data: GptApiResponse }> = ({ data }) => {
  return (
    <div className="h-full flex flex-col justify-center ">
      <div className="block  dark:bg-slate-700 p-6 h-max overflow-y-auto  scrollbar-thin scroll scrollbar-thumb-rounded scrollbar-thumb-slate-800 ">
        ...
        {data.edited_lines.map((line, index) => {
          return (
            <div
              className="block rounded-lg mt-8 mb-0 dark:bg-slate-600 p-6"
              key={index}
            >
